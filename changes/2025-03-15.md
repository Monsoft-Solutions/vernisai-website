...
- Add new database table for tracking audience data (IP, location, referrals, UTM parameters)
- Implement schema and service methods for audience tracking
- Update API endpoint to capture tracking information from waitlist submissions
- Add support for tracking Google Ads and Meta Ads conversions
- Ensure extensibility for future tracking needs
- Maintain separation from core waitlist functionality
