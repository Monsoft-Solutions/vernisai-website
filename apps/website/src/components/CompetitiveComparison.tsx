...
export const workflowAutomationComparison: ComparisonFeature[] = [
    {
    ...
    },
    {
        ...
        description:
            'Uses advanced AI to automate complex tasks that typically require human judgment',
        vernisAI: true,
        competitor1: 'Limited',
        competitor2: false,
        highlight: true,
    ...
    },
    {
        ...
        description: 'AI understands the context of your data and workflows',
        vernisAI: true,
        competitor1: 'Limited',
        competitor2: false,
        highlight: true,
    ...
    {
        name: 'Pricing model',
        vernisAI: 'Usage-based',
        competitor1: 'Per-user',
        competitor2: 'Per-workflow',
    },
    {
        name: 'Free trial',
        vernisAI: '14 days',
