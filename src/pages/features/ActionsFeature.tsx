        ...
        <div className="container mx-auto px-4 py-16">
            <div className="mx-auto max-w-6xl">
                <div className="mb-12 text-center">
                    ...
                    >
                        {totalActions}+ powerful operations that interact with
                ...
                >
                    <p>
                        ...
                        <strong>Model Context Protocol (MCP)</strong>, an open
                        standard that enables AI agents to securely interact
                        with a wide range of tools and services. Our platform
                        provides access to hundreds of actions that can be
                        combined to create powerful automation workflows without
                        writing any code.
                    </p>

                    <div className="my-8 flex items-center justify-between rounded-lg bg-gray-50 p-4">
                    ...
                    <div className="flex flex-col items-center justify-between gap-6 md:flex-row">
                        <div>
                            ...
                            <p className="mb-4 text-gray-600">
                                ...
                                experience the power of VernisAI's action-based
                                automation.
                            </p>
                ...
                >
                    ...
                    <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
                        ...
                        <div className="flex flex-col items-center text-center">
                            ...
                            <p className="text-gray-600">
                                Combine actions into powerful workflows using
                                our intuitive no-code interface.
                            </p>
                        </div>
                        <div className="flex flex-col items-center text-center">
                            <div className="mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-gray-100">
