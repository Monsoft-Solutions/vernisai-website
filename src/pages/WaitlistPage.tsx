        ...
        <div className="overflow-hidden bg-gradient-to-b from-white to-gray-50">
            ...
            <div className="relative">
                ...
                <div className="absolute inset-0 z-0 overflow-hidden">
                    <div className="absolute -left-[10%] -top-[10%] h-[30%] w-[30%] rounded-full bg-blue-100 opacity-20 blur-3xl"></div>
                    <div className="absolute bottom-[10%] right-[5%] h-[40%] w-[40%] rounded-full bg-purple-100 opacity-20 blur-3xl"></div>
                </div>
                ...
                <div className="relative z-10 mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-24">
                    ...
                    >
                        ...
                        <p className="text-muted-foreground mt-6 max-w-2xl text-center text-lg sm:mx-auto">
                            We're opening limited access to our platform soon. Join our exclusive early adopter program 
                            and shape the future of AI-powered workflow automation.
                        </p>
                        ...
                        <div className="mt-10 grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3">
                            ...
                            >
                                ...
                                <h3 className="mt-4 font-semibold">Priority Access</h3>
                                <p className="text-muted-foreground mt-2 text-center text-sm">Skip the line and get access before general release</p>
                            </motion.div>
                            ...
                            >
                                ...
                                <h3 className="mt-4 font-semibold">Exclusive Features</h3>
                                <p className="text-muted-foreground mt-2 text-center text-sm">Test new capabilities before they're widely available</p>
                            </motion.div>
                            ...
                            >
                                ...
                                <h3 className="mt-4 font-semibold">Special Pricing</h3>
                                <p className="text-muted-foreground mt-2 text-center text-sm">Exclusive discounts for early adopters</p>
                            </motion.div>
                        </div>
                    </motion.div>
                    ...
                    >
                        <p className="text-muted-foreground text-sm">
                            Have questions about our early adopter program? Contact us at{' '}
                            <a href="mailto:waitlist@vernis.ai" className="text-blue-600 hover:underline">
                                waitlist@vernis.ai
                            </a>
                        </p>
                    </motion.div>
